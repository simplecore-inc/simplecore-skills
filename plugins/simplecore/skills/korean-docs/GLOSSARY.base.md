...
| /에 있어(?![야도])서?/ | ~에서, ~할 때 | 경고 | "in terms of" 직역. **존재를 말하는 활용형은 뒷글자로 뺀다** — 「목록에 있어야 합니다」의 「있어야」와 「범위 밖에 있어도」의 「있어도」는 이 번역투가 아니다. 둘을 다 열거해야 하는 까닭은 어미마다 음절이 달라 어간 「있어」만으로는 갈리지 않기 때문이다 |
