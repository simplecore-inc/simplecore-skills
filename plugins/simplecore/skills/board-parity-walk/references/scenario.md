...
A checker can hold that every walked frame appears in the document, and that every
step names frames that exist. It cannot hold that the steps still add up; that is
the walker's judgement, which is why the rule is stated rather than merely enforced.
