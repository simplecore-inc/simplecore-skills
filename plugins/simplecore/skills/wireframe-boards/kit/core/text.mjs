...
const en = {
  ...
  axisLabel: 'Narrow by axis',
  axisHint: 'Keeps only the frames of the chosen value — applies together with the text filter',
  axisAll: 'All',
...
const ko = {
  ...
  filterClear: '좁히기 지우기',
  axisLabel: '축으로 좁히기',
  axisHint: '고른 값의 프레임만 목차에 남긴다 — 입력칸과 함께 걸린다',
  axisAll: '전체',
  viewportLabel: '화면 너비',
  narrow: '좁은 쪽',
  wide: '넓은 쪽',
